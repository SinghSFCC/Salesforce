...
function maps() {
    ...
    $('body').off('click', '.results .card-body').on('click', '.results .card-body', function(){  
        google.maps.event.trigger(window.googleMarkers[$(this).prevAll().length], 'click');
...
module.exports = {
    ...
    selectStore: function () {
        $('.store-locator-container').on('click', '.select-store', (function (e) {
            ...
            var mapdiv = $(this).attr('data-store-info');
        }));
    },
